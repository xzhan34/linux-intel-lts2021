...
enum intel_guc_load_status {
	...
	INTEL_GUC_LOAD_STATUS_HWCONFIG_DECRYPTION_START        = 0x05,
	INTEL_GUC_LOAD_STATUS_HWCONFIG_DECRYPTION_DONE         = 0x06,
	INTEL_GUC_LOAD_STATUS_HWCONFIG_DECRYPTION_ERROR        = 0x07,
